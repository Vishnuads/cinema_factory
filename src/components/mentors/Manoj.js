...
import banner from '../../images/mentors/manoj/manoj_desktop.png'
import bannerOne from '../../images/mentors/manoj/manoj_phone.png'

import vfx from '../../images/mentors/manoj/leo.png'
                    ...
                    <div className='relative'>
                        ...
                        <div className='absolute bottom-14 w-full'>
                            <div className='flex justify-center items-center'>
                                <h3 className=' text-[24px] text-center md:text-[45px] font-specialElite font-semibold text-[#ffa500] '>Learn from the Idol of New gen filmmakers</h3>
                            </div>
                        </div>
                            ...
                            <div className='w-full md:w-[50%] mx-auto'>
                                <div className='flex flex-col gap-y-14 justify-center items-start'>
                                    ...
                                    <ul className='ml-3 md:ml-0 list-disc font-semibold text-[12px] md:text-[16px] flex flex-col gap-y-3 md:gap-y-6 text-white'>
                                       <li>Gained recognition with Eeram, known for its innovative use of greys and blacks.</li>
                                       <li>Used captivating whites in the romantic film Vinnaithaandi Varuvaayaa.</li>
                                       <li>Incorporates Virtual Production and Unreal Engine into his filmmaking.</li>
                                       <li>Has worked on numerous successful films, consistently pushing cinematic boundaries.His notable recent films include Radhe Shyam, Beast, and Leo</li>
                                       <li>Showcases expertise in various formats, including an IMAX release of Leo.</li>
                            ...
                            <div className='flex flex-col md:flex-row gap-y-10 items-center'>
                                ...
                                <div className=' w-full md:w-[50%] mx-auto'>
                                    <div>
                                        ...
                                        <ul className='list-disc text-[12px] md:text-[14px] mt-6 md:mt-8 ml-4 space-y-3 md:space-y-5 text-gray-200'>
                                            <li>Awards:Won the Filmfare Award for Best Cinematographer - South for Vinnaithaandi Varuvaayaa and Ye Maaya Chesave.</li>
                                            <li>Notable Projects: Gained acclaim for his work in  Eeram, Nadunisi Naaygal, Nanban, and Beast</li>
                                            <li> Production Ventures: Expanded into production with the film Poovarasam Peepee in 2014.</li>
                                            <li>Recent Works:Contributed to high-profile projects like Leo (2023), Guntur Kaaram, Dhruva Natchathiram, and is co-producing the upcoming film Minmini.</li>
                                ...
                                <div className='w-full md:w-[50%] mx-auto'>
                                    ...
                                    <div className='flex justify-center md:justify-end'>
                                        <img src={vfx} className='w-full md:w-[80%] object-cover' alt="" />
                                    </div>
