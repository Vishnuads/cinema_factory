...
import banner from '../../images/mentors/raja/raja_website.png'
import bannerOne from '../../images/mentors/raja/raja_phone.png'

import rajasuccess from '../../images/mentors/raja/raja.png'


import posterOne from '../../images/poster/raja/1.png'
import posterTwo from '../../images/poster/raja/2.png'
import posterThree from '../../images/poster/raja/3.png'
import posterFour from '../../images/poster/raja/4.png'
import poterFive from '../../images/poster/raja/5.png'
import posterSix from '../../images/poster/raja/6.png'
import posterSeven from '../../images/poster/raja/7.png'
import posterEight from '../../images/poster/raja/8.png'
import posterNine from '../../images/poster/raja/9.png'
import posterTen from '../../images/poster/raja/10.png'
                    ...
                    <div className='relative'>
                        ...
                        <div className='absolute bottom-14 w-full'>
                            <div className='flex justify-center items-center'>
                                <h3 className=' text-[20px] text-center md:text-[45px] font-specialElite font-semibold text-[#ffa500] '>Learn from the Maestro Raja Mohammad, the Art of Seamless Storytelling through Masterful Editing</h3>
                            </div>
                        </div>
                            ...
                            <div className='w-full md:w-[50%] mx-auto h-full'>
                                ...
                                <div className='w-full h-full'>
                                    ...
                                    <div className='flex justify-center md:justify-end'>
                                        <img src={rajasuccess} className='w-full md:w-[80%] object-cover' alt="" />
                                    </div>
                                </div>
                            ...
                            <div className='w-full md:w-[50%] mx-auto'>
                                <div className='flex flex-col gap-y-14 justify-center items-start'>
                                    ...
                                    <ul className='ml-3 md:ml-0 list-disc font-semibold text-[12px] md:text-[16px] flex flex-col gap-y-3 md:gap-y-6 text-white'>
                                        <li>Began editing career in Malayalam cinema with films like "Nakshathrakkannulla Rajakumaran Avanundoru Rajakumari" (2002) and "Thanmathra" (2005).</li>
                                        <li>Transitioned to Tamil cinema with "Nala Damayanthi" (2003), produced by Kamal Haasan.</li>
                                        <li>Known for his meticulous editing style and ability to enhance storytelling through seamless narrative integration</li>
                                        <li>Collaborated with prominent directors, including M. Sasikumar</li>
                                        <li>Worked on notable Tamil films such as "Raam" (2005), "Paruthiveeran" (2007), "Kalavani" (2010), and "Mounaguru" (2011).</li>
                                        <li>Well-Versed in Film editing software like Avid, FCP, Adobe Premiere</li>
                                ...
                                <div className=' w-full md:w-[50%] mx-auto'>
                                    <div>
                                        ...
                                        <ul className='list-disc text-[12px] md:text-[14px] mt-6 md:mt-8 ml-4 space-y-3 md:space-y-5 text-gray-200'>
                                            <li>National Film Award: Best Editing for Paruthiveeran (2007)</li>
                                            <li>Tamil Nadu State Government Award: For Vaagai Sooda Vaa (2011)</li>
                                            <li>Kerala Critics Award</li>
                                            <li>Vijay Award: Best Editor for Subramaniapuram (2008)</li>
                                            <li>Vikatan Awards: Best Film Editor for Subramaniapuram and Oru Kanniyum Moonu Kalavaanikalum</li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div className=''>
                            ...
                            <div className="slider-container  mx-auto">
                                <Slider {...settings} className="">
                                    ...
                                    <div className='px-2'>
                                        <img src={poterFive} className='w-full object-cover' alt="" />
                                    </div>
