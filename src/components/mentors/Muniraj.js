...
import banner from '../../images/mentors/MuniRaj/muniraj web.png'
import bannerOne from '../../images/mentors/MuniRaj/muniraj phone.png'

import munisuccess from '../../images/mentors/MuniRaj/muniraj_work.png'


import posterOne from '../../images/poster/muniraj/1.png'
import posterTwo from '../../images/poster/muniraj/2.png'
import posterThree from '../../images/poster/muniraj/3.png'
import posterFour from '../../images/poster/muniraj/4.png'
                    ...
                    <div className='relative'>
                        ...
                        <div className='absolute bottom-14 w-full'>
                            <div className='flex justify-center items-center'>
                                <h3 className=' text-[20px] text-center md:text-[45px] font-specialElite font-semibold text-[#ffa500] px-4 '>Pioneer of Creative Solutions in Film Technology and Production</h3>
                            </div>
                        </div>
                            ...
                            <div className='w-full md:w-[50%] mx-auto h-full'>
                                ...
                                <div className='w-full h-full'>
                                    ...
                                    <div className='flex justify-center md:justify-end'>
                                        <img src={munisuccess} className='w-full md:w-[80%] object-cover' alt="" />
                                    </div>
                                </div>
                            ...
                            <div className='w-full md:w-[50%] mx-auto'>
                                <div className='flex flex-col gap-y-14 justify-center items-start'>
                                    ...
                                    <ul className='ml-3 md:ml-0 list-disc font-semibold text-[12px] md:text-[16px] flex flex-col gap-y-3 md:gap-y-6 text-white'>
                                        <li>Over 12 years as a Digital Imaging Technician (DIT) and Creative Technologist in the filmmaking industry.</li>
                                        <li>Notable contributions to films such as Thaanaa Serndha Koottam, Kaala, Marina, Vikram Vedha (Hindi), Mumbai Police, and Super Deluxe.</li>
                                        <li>Played a key role in both Bollywood and Kollywood, showcasing versatility across diverse projects.</li>
                                        <li>Known as a reliable and innovative professional, consistently adding significant value to films and ensuring seamless workflows.</li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div className=' w-full md:w-[50%] mx-auto'>
                                    <div>
                                        ...
                                        <ul className='list-disc text-[12px] md:text-[14px] mt-6 md:mt-8 ml-4 space-y-3 md:space-y-5 text-gray-200'>
                                            ...
                                            <li>Problem-Solving Skills: Exceptional ability to address on-the-spot issues during film production, ensuring smooth operations.</li>
                                            <li>Innovation: Known for an innovative approach that enhances the production process and brings creativity to projects.</li>
                                            <li>Technical Expertise: Specialized in digital imaging technology, contributing significantly to the technical aspects of film production.</li>
