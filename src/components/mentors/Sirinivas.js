...
import banner from '../../images/mentors/Sirinivas/srinivas_web.png'
import bannerOne from '../../images/mentors/Sirinivas/srinivas_phone.png'

import vfx from '../../images/mentors/Sirinivas/srinivas_work.png'


import posterOne from '../../images/poster/sri/1.png'
import posterTwo from '../../images/poster/sri/2.png'
import posterThree from '../../images/poster/sri/3.png'
import posterFour from '../../images/poster/sri/4.png'
import posterFive from '../../images/poster/sri/5.png'
import posterSix from '../../images/poster/sri/6.png'
import posterSeven from '../../images/poster/sri/7.png'
                    ...
                    <div className='relative'>
                        ...
                        <div className='absolute bottom-14 w-full'>
                            <div className='flex justify-center items-center'>
                                <h3 className=' text-[18px] text-center md:text-[45px] font-specialElite font-semibold text-[#ffa500] '>Learn from the visionary behind some of Indian cinema's most groundbreaking visual effects.</h3>
                            </div>
                        </div>
                            ...
                            <div className='w-full md:w-[50%] mx-auto'>
                                <div className='flex flex-col gap-y-14 justify-center items-start'>
                                    ...
                                    <ul className='ml-3 md:ml-0 list-disc font-semibold text-[12px] md:text-[16px]  gap-y-3 md:gap-y-6 text-white grid grid-cols-1 md:grid-cols-2 gap-x-4'>
                                        ...
                                        <li>Visual Effects Supervisor for films in Telugu, Tamil, Malayalam, Hindi, and Kannada languages.</li>
                                        <li>Expertise in visual effects, digital compositing, and special effects supervision</li>
                                        <li>Notable films include:</li>
                                        <li>Indian (1996)</li>
                                        <li>Kadhalar Dhinam (1997)</li>
                                        <li>Jeans (1998)</li>
                                        <li>Kushi (2000)</li>
                                        <li>Raavanaprabhu (2001)</li>
                                        <li>Dhool (2003)</li>
                                        <li>Sivaji (2007)</li>
                                        <li>Enthiran (2010)</li>
                                ...
                                <div className='w-full md:w-[50%] mx-auto'>
                                    <div>
                                        ...
                                        <ul className='list-disc text-[12px] md:text-[14px] mt-6 md:mt-8 ml-4 space-y-3 md:space-y-5 text-gray-200'>
                                            <li>National Film Awards for Best Special Effects for movies  Magic Magic (2003), Sivaji Enthiran,Baahubali: The Beginning (2015), RRR </li>
                                            <li>IIFA Award for Best Special Effects (2010).</li>
                                            <li>Star Screen Awards:</li>
                                            <li>Best Special Effects (2010)</li>
                                            <li>Special Jury Award for spectacular cutting-edge technology (2010).</li>
                                            <li>NDTV Gadget Guru Award for Best Special Effects (2015).</li>
                                            <li>Movers & Shakers Award for Best VFX at 24FPS International Animation Awards (2015).</li>
                                        </ul>
                                    </div>
                                </div>
