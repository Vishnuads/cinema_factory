...
import banner from '../../images/mentors/stanly/stanly_web.png'
import bannerOne from '../../images/mentors/stanly/stanly_phone.png'

import vfx from '../../images/mentors/stanly/stanley_work.png'
                            ...
                            <div className='w-full md:w-[50%] mx-auto'>
                                <div className='flex flex-col gap-y-14 justify-center items-start'>
                                    ...
                                    <ul className='ml-3 md:ml-0 list-disc font-semibold text-[12px] md:text-[16px] flex flex-col gap-y-3 md:gap-y-6 text-white'>
                                      <li>Directed debut film "April Maadhathil" (2002), a college love story featuring Srikanth and Sneha.</li>
                                      <li> Directed "Pudhukottaiyilirundhu Saravanan" (2004), starring Dhanush.</li>
                                      <li>Collaborated with Srikanth again in "Mercury Pookkal" (2006), a romantic drama.</li>
                                      <li>Directed "Kizhakku Kadalkarai Salai" (2006)</li>
                                      <li>Collaborated with Legendary Director Mani Ratnam for the film Raavanan.</li>
                                      <li>Worked as an actor in several films, portraying notable roles.</li>
                                      <li>His latest film as Director “ Lockdown Nights”</li>
                                ...
                                <div className='w-full md:w-[50%] mx-auto'>
                                    <div>
                                        ...
                                        <ul className='list-disc text-[12px] md:text-[14px] mt-6 md:mt-8 ml-4 space-y-3 md:space-y-5 text-gray-200'>
                                           <li>Established a reputation as a filmmaker with a focus on nuanced character portrayals and contemporary narratives.</li>
                                           <li>Honorary lifetime member of  Film Directors Association of Malaysia</li>
                                           <li>Played C. N. Annadurai in the biographical film "Periyar" (2007), showcasing his versatility as an actor.</li>
                                           <li>Continued to explore diverse themes and genres in Tamil cinema, both as a director and actor.</li>
                                        </ul>
                                    </div>
                                </div>
