...
import banner from '../../images/mentors/Arathai/aranthai_manian.png'
import bannerOne from '../../images/mentors/Arathai/aranthai_mobile.png'

import book from '../../images/mentors/Arathai/aranthai_book.png'


import posterOne from '../../images/poster/aranthai/1.jpg'
import posterTwo from '../../images/poster/aranthai/2.jpg'
import posterThree from '../../images/poster/aranthai/3.jpg'
import posterFour from '../../images/poster/aranthai/4.jpg'
import posterFive from '../../images/poster/aranthai/5.jpg'
import posterSix from '../../images/poster/aranthai/6.jpg'
import posterSeven from '../../images/poster/aranthai/7.jpg'
import posterEight from '../../images/poster/aranthai/8.jpg'
import posterNine from '../../images/poster/aranthai/9.jpg'
import posterTen from '../../images/poster/aranthai/10.jpg'
                    ...
                    <div className='relative'>
                        ...
                        <div className='absolute bottom-14 w-full'>
                            <div className='flex justify-center items-center'>
                                <h3 className=' text-[16px] text-center md:text-[45px] font-specialElite font-semibold text-[#ffa500] px-4 md:px-8 '>Learn from the versatile Aranthai Manian, whose profound insights in filmmaking, criticism, and scholarship have shaped Tamil cinema and literature</h3>
                            </div>
                        </div>
                            ...
                            <div className='w-full md:w-[50%] mx-auto h-full'>
                                ...
                                <div className='w-full h-full'>
                                    ...
                                    <div className='flex justify-center md:justify-end'>
                                        <img src={book} className='w-full md:w-[90%] object-cover' alt="" />
                                    </div>
                                </div>
                            ...
                            <div className='w-full md:w-[50%] mx-auto'>
                                <div className='flex flex-col gap-y-14 justify-center items-start'>
                                    ...
                                    <ul className='ml-3 md:ml-0 list-disc font-semibold text-[12px] md:text-[16px] flex flex-col gap-y-3 md:gap-y-6 text-white'>
                                        <li> Filmmaker, film critic, scholar, historian, and actor</li>
                                        <li>Experience in television serials, documentaries, and advertisement films</li>
                                        <li>Directed the legendary actor Shivaji Ganesan in television projects</li>
                                        <li>Education includes a postgraduate degree in English Literature, a Diploma in Journalism, and training in Screenplay Writing and Direction at the Film and Television Institute of India, Pune</li>
                                ...
                                <div className=' w-full md:w-[50%] mx-auto'>
                                    <div>
                                        ...
                                        <ul className='list-disc text-[12px] md:text-[14px] mt-6 md:mt-8 ml-4 space-y-3 md:space-y-5 text-gray-200'>
                                            <li> Authored 35 books in Tamil on subjects including films, music, biographies, and history</li>
                                            <li> Recognized for significant contributions to Tamil literature and film studies</li>
                                            <li> Directed and contributed to influential television and film projects</li>
...
export default AranthaiManiyan
